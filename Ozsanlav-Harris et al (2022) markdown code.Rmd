...
Cook_BasicBandAR <- read_csv("Cook (2021) outputs/BasicBand_ARs_Cook.csv")
...
## Save a plot
#ggsave("OH et al (2022) plots/BasicBand_SpeciesGroup.png", 
...
outputpath <- paste0("OH et al (2022) plots/BasicBandAR_", " table", ".png")
...
Cook_ExtBandAR <- read_csv("Cook (2021) outputs/ExtBand_ARs_Cook.csv")
...
## Save a plot
#ggsave("OH et al (2022) plots/ExtBand_SpeciesGroup.png", 
#       width = 28, height = 15, units = "cm")
...
outputpath <- paste0("OH et al (2022) plots/ExtBandAR_", " table", ".png")
...
## Read in the data set
Cook_StBasicBandAR <- read_csv("/Cook (2021) outputs/StBasicBand_ARs_Cook.csv")
...
## Save a plot
#ggsave("OH et al (2022) plots/BasicBandSt_SpeciesGroup.png", 
#        width = 28, height = 15, units = "cm")
...
outputpath <- paste0("OH et al (2022) plots/StBasicBandAR_", " table", ".png")
...
## Read in the data set
Cook_StExtBandAR <- read_csv("Cook (2021) outputs/StExtBand_ARs_Cook.csv")
...
## Save a plot
#ggsave("OH et al (2022) plots/ExtBandSt_SpeciesGroup.png", 
#        width = 28, height = 15, units = "cm")
...
outputpath <- paste0("OH et al (2022) plots/StExtBandAR_", " table", ".png")
